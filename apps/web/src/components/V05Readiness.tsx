export function V05Readiness() {
  return (
    <section className="panel">
      <p className="eyebrow">v1.1.0-dev</p>
      ...
      <div className="checklist-grid">
        ...
        <div className="checklist-item"><strong>Trazado de herramientas</strong><span>Registro de llamadas, entradas, salidas, latencia y estado por herramienta.</span></div>
